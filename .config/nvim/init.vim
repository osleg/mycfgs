...
" Plugins {{{
  " Plugins List {{{
    ...
    " General {{{
      ...
      Plug 'vim-scripts/sessionman.vim', { 'on': ['SessionOpen','SessionSave'] }
    ...
    " OrgMode {{{
      ...
      Plug 'chrisbra/NrrwRgn', { 'for': ['orgmode', 'org'] }
      Plug 'osleg/calendar-vim', { 'for': ['orgmode', 'org'] }
      Plug 'vim-scripts/SyntaxRange', { 'for': ['orgmode', 'org'] }
    ...
    " Languages {{{
      ...
      " HTML {{{
        Plug 'amirh/HTML-AutoCloseTag', { 'for': ['html', 'jinjahtml', 'htmljinja'] }
        Plug 'hail2u/vim-css3-syntax', { 'for': ['html', 'jinjahtml', 'htmljinja'] }
        Plug 'gorodinskiy/vim-coloresque', { 'for': ['html', 'jinjahtml', 'htmljinja'] }
        Plug 'mitsuhiko/vim-jinja', { 'for': ['html', 'jinjahtml', 'htmljinja'] }
        Plug 'mattn/emmet-vim', { 'for': ['html', 'jinjahtml', 'htmljinja'] }
      " }}}
...
" Keymappings {{{
  ...
  " Plugins Mappings {{{
    ...
    " CtrlSF {{{
      ...
      vmap     <Leader>fS <Plug>CtrlSFVwordPath
      vmap     <Leader>fs <Plug>CtrlSFVwordExec
      nnoremap <Leader>fF :CtrlSFOpen<CR>
